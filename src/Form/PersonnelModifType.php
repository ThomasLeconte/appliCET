...
class PersonnelModifType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('nomPatronymique', null, array('label' => 'Nom patronymique', 'invalid_message' => 'Le champ est incorrect'))
            ->add('prenom', null, array('label' => 'Prénom', 'invalid_message' => 'Le champ est incorrect'))
            ->add('etatCloture', CheckboxType::class, array('required'=> false, 'label' => 'Clôturé'))
            ->add('typeCloture')
            ->add('affectation')
            ->add('grade')
        ;
